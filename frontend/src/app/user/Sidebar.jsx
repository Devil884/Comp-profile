...
const Sidebar = () => {
    ...
    return (
        <div>
            ...
            <aside className="flex flex-col w-[250px] h-screen px-4 py-8 overflow-y-auto bg-yellow-100  dark:bg-gray-900  fixed ">
                    ...
                    currentUser.profile && (
                        <div className="flex flex-col items-center mt-6 -mx-2">
                            <img
                                ...
                                src={'http://localhost:5000/' + currentUser.profile.logo}
                                alt="avatar"
                            />
                ...
                <div className="flex flex-col justify-between flex-1 mt-6">
                    <nav>
                        ...
                        >
                            ...
                            <span className="mx-4 font-medium"> <Link href={'/feedback'}>Feedback</Link></span>
                        </a>
                        <a
                            className="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"
                            href="#"
