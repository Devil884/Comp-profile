  ...
  return (
    <div className="relative  ">
      <img
        ...
        alt=""
      />
      <div className="relative bg-opacity-80 bg-purple-200  ">
        <svg
        ...
        <div className="relative px- py- mx-auto overflow-hidden sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
