...
const BrowseProfile = () => {
  ...
  const searchCompany = (e) => {
    ...
    console.log(value);
    setProfileList(
      masterList.filter(profile => profile.name.toLowerCase().includes(value))
    );
  ...
  return (
    <div>
      <div className="sticky inset-x-0 z-20 bg-white border-y px-4 sm:px-6 md:px-8 lg:hidden dark:bg-neutral-800 dark:border-neutral-700">
