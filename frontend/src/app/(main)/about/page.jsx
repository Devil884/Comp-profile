...
{/* Features */}
        ...
        <div className="max-w-6xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
          <div className="min-h-[35vh] md:min-h-[75vh] bg-[url('https://www.solutionsget.com/wp-content/uploads/2016/10/About-Us-1.jpg')] bg-center bg-cover bg-no-repeat relative rounded-xl">
